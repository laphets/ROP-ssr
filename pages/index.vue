...
export default {
    ...
    async asyncData (context) {
        ...
        // console.log(this)
        const { data } = ((await axios.get(`http://localhost:3000/v1/ssr/schedule?uid=${uid}`)).data)
    ...
    methods: {
        ...
        async submit(intent_id) {
            await axios.post(`http://localhost:3000/v1/ssr/join/${this.radioSelectList[intent_id]}`, {
                intents: [intent_id]
            })
